 ...
 * A viharok feltámadásnak valószínűségeit, és annak lebonyolításának kezdetét is ez az osztály kezeli.
 */
public class Game {
     ...
     * Ezt követően a bekért adatok alapján létrehozza az eszkimókat illetve a sarkkutatókat
    ...
    /**
     * Ciklusban hívogatja meg a játékosok köreinek lezajlásáért felelős függvényeket.
     * A ciklus minden lefutása során először egy adott valószínűség alapján eldönti hogy jön-e vihar.
     * Ha jön, akkor meghívja a Gameboard storm() függvényét (ellenkező esetben ez a függvényhívás kimarad).
    ...
    /**
     * A megkapott paraméter alapján eldönti, hogy hogyan végződik a játék, majd befejezi azt.
     *
    ...
    /**
     * Megvizsgálja, hogy a játékosok összegyűjtötték-e a három szükséges tárgyat (GUN, FLARE, CHARGE),
