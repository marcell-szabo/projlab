...
public class Game {
	...
	* A flare_gun attribútum értékét változtatja meg, mégpedig úgy, hogy hozzáad egy új FlareGun példányt a listához.
    ...
    /**
	* Megvizsgálja, hogy a játékosok összegyűjtötték-e a három szükséges tárgyat (GUN, FLARE, CHARGE), tehát három elemet tartalmaz-e a flare_gun lista. Ha igen, akkor TRUE, máskülönben FALSE értékkel fog visszatérni.
